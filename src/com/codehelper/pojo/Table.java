...
public class Table {
    ...
    private static String     sqlMapPackage  = ConfigUtils.getConfig("sqlMapPackage");
    private static String     pojoPackage    = ConfigUtils.getConfig("pojoPackage");   // pojo包名称
    private static String     daoPackage     = ConfigUtils.getConfig("daoPackage");    // dao包名称
    private static String     daoTestPackage = ConfigUtils.getConfig("daoTestPackage"); // daoTest包名称
    private static String     bizPackage     = ConfigUtils.getConfig("bizPackage");    // imp包名称
    private static String     xmlPackage     = ConfigUtils.getConfig("xmlPackage");    // xml包名称
    ...
    public Table(String className, String classNameD, String classNameX, String className_Java,
