...
import com.codehelper.pojo.TableBind;
import com.codehelper.pojo.TableCarray;
import com.codehelper.pojo.TableIndex;
...
public class TableUtils {
	...
	public static final List<Table> getTables(Connection conn) throws Exception {
		...
		for (String tableName : tabelNames) {
			...
			String createDate = new SimpleDateFormat("yyyy年MM月dd日").format(new Date());//文件生成日期
			...
			table = new Table(className, className_d, className_x,className_Java,tableCarrays, tableIndexs,
